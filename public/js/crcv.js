...
const listPages = [``,`
                    ...
                    <div class="images">
                        ...
                        <h3>Descompresión espinal</h3>
                            <figure class="img--container">
                                ...
                                <img src="./public/img/drx9000-crcvpanama.avif" alt="drx9000 descompresión espinal">
            ...
            <summary>Leer más...</summary>
                ...
                <div class="content--videos" id="testimonios">
                    <div>
                        <video controlsList="nodownload" controls playsinline oncontextmenu="return false" preload="none" poster="./public/img/svg/crcvlogo.svg">
